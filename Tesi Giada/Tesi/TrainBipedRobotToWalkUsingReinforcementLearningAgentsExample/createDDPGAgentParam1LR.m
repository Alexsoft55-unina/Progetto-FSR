function agent = createDDPGAgentParam1LR(numObs, obsInfo, numAct, actInfo, Ts)
...
criticOptions = rlOptimizerOptions('Optimizer','adam','LearnRate',5e-4,... 
                                        'GradientThreshold',1,'L2RegularizationFactor',2e-4);
actorOptions = rlOptimizerOptions('Optimizer','adam','LearnRate',5e-4,...
