...
def generate_launch_description():
    ...
    balance_jump_controller = Node(
        ...
        output='screen',
        emulate_tty=True,
        # Set start_controller:=false to bring up Gazebo/spawn/controllers here and run
        # balance_jump_controller by hand from another terminal (see README command below).
        ...
        parameters=[{
            ...
            'planar_enable': ParameterValue(LaunchConfiguration('planar_enable'), value_type=bool),
            'traj_length': ParameterValue(LaunchConfiguration('traj_length'), value_type=float),
            'traj_lateral': ParameterValue(LaunchConfiguration('traj_lateral'), value_type=float),
            'traj_duration': ParameterValue(LaunchConfiguration('traj_duration'), value_type=float),
        }],
    )
