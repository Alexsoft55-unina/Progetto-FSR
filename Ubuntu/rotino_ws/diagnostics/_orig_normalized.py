...
MuJoCo -> ROS 2 mapping:
  ...
  hip/knee position servo        -> /rotino/<joint>/cmd_pos target angles [rad] (gz JointPositionController)
"""
...
class BalanceJumpController(Node):
    ...
    def __init__(self):
        ...
        self.leg_pubs = [self.create_publisher(Float64, f'/rotino/{name}/cmd_pos', 10) for name in LEG_JOINTS]
