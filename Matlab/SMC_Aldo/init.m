...
K.q1_ref  = 0.00;          % GINOCCHIO  [rad]
K.q2_ref  = -0.30;         % ANCA       [rad]   (q3 NON ha riferimento: e' libero)
...
K.c3 = 12.0;   K.k3 = 60.0;   K.eta3 = 20.0;   K.phi3 = 0.05;   % ANCA

% ---- Limiti attuatori e aderenza ---------------------------------------
K.TAU_MAX = [25; 120; 120];        % [tau_w ; tau_1(gin.) ; tau_2(anca)]
K.mu      = 0.8;
K.N_nom   = (robot_params.mw+robot_params.m1+robot_params.m2+robot_params.m3)*robot_params.g;
