function [l_eq, theta_eq, S_C, Z_C] = calcola_CoM_equivalente(q, robot_params)
    ...
    %
    % Input:
    %   q            - Vettore di stato 4x1 [q1; qw; q2; q3] (rad)
    ...
    % q(2) è la ruota (q_w), la ignoriamo perché l'origine è il centro ruota
    q1 = q(1);
    q2 = q(3);
    q3 = q(4); % q3 è assunto come l'angolo assoluto del torso dalla verticale
