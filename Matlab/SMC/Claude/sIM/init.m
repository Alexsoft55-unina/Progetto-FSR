...
%% ---------- 1. Parametri ----------
robot_params.Rw = 0.127;  robot_params.mw = 3.5;   robot_params.Iw = 0.1;
robot_params.m1 = 1.2;    robot_params.m2 = 5.3;   robot_params.m3 = 60.0;
robot_params.l1 = 0.45;   robot_params.l2 = 0.45;  robot_params.l3 = 0.35;
robot_params.g  = 9.81;
robot_params.I1 = (1/12)*robot_params.m1*robot_params.l1^2;
robot_params.I2 = (1/12)*robot_params.m2*robot_params.l2^2;
robot_params.I3 = (1/12)*robot_params.m3*robot_params.l3^2;      % ipotesi asta sottile: DA RIVEDERE per un torso di 60 kg
save('robot_params.mat','robot_params');
...
Rw=robot_params.Rw; mw=robot_params.mw; Iw=robot_params.Iw; m1=robot_params.m1; m2=robot_params.m2; m3=robot_params.m3;
l1=robot_params.l1; l2=robot_params.l2; l3=robot_params.l3; g=robot_params.g; I1=robot_params.I1; I2=robot_params.I2; I3=robot_params.I3;
