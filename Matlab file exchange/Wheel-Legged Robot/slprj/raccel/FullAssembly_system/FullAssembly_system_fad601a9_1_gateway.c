...
#endif
#include "nesl_rtw.h"
#include "FullAssembly_system_fad601a9_49.h"
#include "FullAssembly_system_fad601a9_1_gateway.h"
void FullAssembly_system_fad601a9_1_gateway ( void ) { NeModelParameters
modelparams = { ( enum NeSolverTypeTag ) 0 , 0.001 , 0.001 , 0.001 , TRUE ,
FALSE , ( enum NeModifyAbsTolTag ) 2 , 0.001 , 0.0 , FALSE , FALSE , FALSE ,
( enum SscLoggingSettingTag ) 0 , 703447594.0 , FALSE , FALSE , FALSE } ;
NeSolverParameters solverparams = { TRUE , TRUE , FALSE , FALSE , FALSE ,
FALSE , TRUE , FALSE , FALSE , 0.001 , 1e-06 , 1e-09 , FALSE , FALSE , 100U ,
FALSE , 1U , ( enum NeConsistencySolverTag ) 0 , ( enum
...
FullAssembly_system_fad601a9_49_dae ( & dae , & modelparams , & solverparams
) ; nesl_register_simulator_group ( "FullAssembly_system/WORLD_settings/Solver Configuration_1" , 1 , & dae , & solverparams , & modelparams , numOutputs , outputparameters , 0 , rtpDaes , 1 , rtwLogDaes , 0 , solverHitDaes ) ; }
