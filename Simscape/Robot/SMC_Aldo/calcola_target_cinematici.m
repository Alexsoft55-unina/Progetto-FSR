function q_des_calc = calcola_target_cinematici(h_des, robot_params,q0_guess)
    ...
    cinematica_vincoli = @(q_var) [
        (robot_params.m1*robot_params.l1/2 + (robot_params.m2+robot_params.m3)*robot_params.l1)*cos(q_var(1)) + ...
            (robot_params.m2*robot_params.l2/2 + robot_params.m3*robot_params.l2)*cos(q_var(1)+q_var(2)) + ...
        (robot_params.m3*robot_params.l3/2)*cos(q_var(1)+q_var(2)+q_var(3));
